...
public class Main {
     ...
     *    2f: The number of kilometers from any 2 places in the world => int or short
     */
    ...
    public static void exercise3() {
        ...
        LocalDate myDate = LocalDate.of(2024, Month.JUNE, 2);
        ;
        System.out.println(myDate.isBefore(LocalDate.now()));
    }
}
