...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("Investment value reached " + currentInvestmentValueEuros);
    }
    ...
    private static void exercise2() {
       ...
       while(remainingPoundsToSell != 0) {
           ...
           if(poundToEuroExchangeRate > 1.15){
              ...
              System.out.println("Today Exchange Rate " + poundToEuroExchangeRate + " and Sold 1000 pounds. Remaining "
              +  remainingPoundsToSell + " Pounds");
           }
           daysToSell++;
       }
